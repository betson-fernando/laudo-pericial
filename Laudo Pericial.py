...
contAlt = sum([sum([fig.numFigs for fig in figs]) for figs in [figLencol, figBolso, [figPessoas]]]) # Contador para o número de figuras que indicam alterações no local de crime.
